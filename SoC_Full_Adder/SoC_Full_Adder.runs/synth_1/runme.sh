...
HD_PWD='C:/Users/kagan/Documents/Vivado Projects/SoC_Full_Adder/SoC_Full_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SOCadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SOCadder.tcl
