...
HD_PWD='C:/Users/kagan/Documents/Vivado Projects/SoC_Full_Adder/SoC_Full_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOCadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOCadder.tcl -notrace
